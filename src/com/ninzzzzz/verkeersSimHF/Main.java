...
public class Main {
    public static void main(String[] args) {
        int followNumber = 1; // Start the follow number at 1 and increment it as we add vehicles
        ...
        north.addVehicleToWegdek(new Vehicle("EF-9012", 3, followNumber++));  // Police (3rd vehicle)
        ...
        south.addVehicleToWegdek(new Vehicle("OP-2345", 2, followNumber++));  // Fire truck (17th vehicle)
        ...
        west.addVehicleToWegdek(new Vehicle("ST-2345", 1, followNumber++));  // Ambulance (9th vehicle)
